# Anorm Developer & Contributor Guidelines
...
* If you are not 100% sure that it is a bug, then ask about it on the [Stack Overflow tag](http://stackoverflow.com/questions/tagged/anorm) first. You will get a lot more help a lot quicker on the mailing list if you raise it there.  The issue tracker is for verified bugs, not for questions.
* If you have a feature request, please raise it first on the Play developer mailing list. The mailing list is the best forum to discuss new features, and it may be that Anorm already provides something to achieve what you want to achieve and you didn't realise.
...
2. Ensure that your contribution meets the following guidelines:
    ...
    3. The code must be well documented in the Anorm standard documentation format (see the ‘Documentation’ section below). Each API change must have the corresponding documentation change.
...
2. Before starting to work on a feature or a fix, you have to make sure that:
    1. There is a ticket for your work in the project's issue tracker. If not, create it first (See: https://github.com/playframework/anorm/issues).
...
The documentation lives as markdown pages in the `docs/manual` directory. The documentation must conform to the Play [documentation guidelines](http://www.playframework.com/documentation/latest/Documentation).
